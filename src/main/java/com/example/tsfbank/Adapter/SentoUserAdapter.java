...
public class SentoUserAdapter extends BaseAdapter {
    public Context context;
    public ArrayList<UserData> al;
    private TextView userName,accNo,balance;
    public SentoUserAdapter(Context context,ArrayList<UserData> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        balance.setText(al.get(position).getBalance());
